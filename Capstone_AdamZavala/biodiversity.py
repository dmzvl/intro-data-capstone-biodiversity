...
chi2_reptile_mammal, pval_reptile_mammal, dof_reptile_mammal, expected_reptile_mammal = chi2_contingency(contingency2)
...
# In[36]:
import math
yellowstone_weeks = math.ceil(sample_size_per_variant / 507)
bryce_weeks = math.ceil(sample_size_per_variant / 250)
smoky_weeks = math.ceil(sample_size_per_variant / 149)
yosemite_weeks = math.ceil(sample_size_per_variant / 282)
